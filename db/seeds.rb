...
Review.create(user_id: tome.id, restaurant_id: counter.id, content: "If you love burgers you gotta try this place!", title: "Yummy")
Review.create(user_id: may.id, restaurant_id: katz.id, content: "The pastrami is to die for!", title: "Iconic Deli")
Review.create(user_id: may.id, restaurant_id: katz.id, content: "I always order the Pastrami Sandwich!", title: "Nothing Like It")
Review.create(user_id: may.id, restaurant_id: katz.id, content: "All I can say is try the pastrami!", title: "Best in NYC")